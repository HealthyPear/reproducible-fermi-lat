...
\author{Some Guy\inst{1}}

\institute{Some Institute\\
          \email{some.guy@some.domain}\\
         }
...
\begin{figure}[h!]
   \script{plot_null_hypothesis_tsmap.py}
   \begin{centering}
       \includegraphics[width=\hsize]{figures/null_hypothesis_pointsource_powerlaw_2.00_tsmap_sqrt_ts.png}
       \caption{
...
We downloaded data from the coordinates \variable{output/download_coordinates.txt}.
...
%-------------------------------------------------------------
   \begin{figure*}
         ...
         \includegraphics[angle=90]{figures/null_hypothesis_pointsource_powerlaw_2.00_tsmap_sqrt_ts.png}
         \includegraphics{figures/null_hypothesis_pointsource_powerlaw_2.00_tsmap_sqrt_ts.png}
...
%    \resizebox{\hsize}{!}
%             {\includegraphics {figures/null_hypothesis_pointsource_powerlaw_2.00_tsmap_sqrt_ts.png}}
%             %{\includegraphics[bb=10 20 100 100,clip]{figures/null_hypothesis_pointsource_powerlaw_2.00_tsmap_sqrt_ts.png}}
...
%-------------------------------------------------------------
   \begin{figure}[h!]
   \centering
   \includegraphics[angle=-90,width=2cm]{figures/null_hypothesis_pointsource_powerlaw_2.00_tsmap_sqrt_ts.png}
...
%-------------------------------------------------------------
   \begin{figure}[h!]
   \sidecaption
   \includegraphics[width=2cm]{figures/null_hypothesis_pointsource_powerlaw_2.00_tsmap_sqrt_ts.png}
...
%-------------------------------------------------------------
   \begin{figure}
   \centering
   \includegraphics[bb=5 20 60 60,width=3cm,clip]{figures/null_hypothesis_pointsource_powerlaw_2.00_tsmap_sqrt_ts.png}
...
%-------------------------------------------------------------
   ...
   \begin{figure}
   \centering
   \includegraphics[width=3cm]{figures/null_hypothesis_pointsource_powerlaw_2.00_tsmap_sqrt_ts.png}
